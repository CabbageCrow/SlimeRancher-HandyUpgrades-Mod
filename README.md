...
Get the file [**HandyUpgrades_v#.#.#.umfmod**](https://github.com/CabbageCrow/SlimeRancher-HandyUpgrades-Mod/releases/download/v0.2.3/HandyUpgrades_v0.2.3.umfmod) and put it into the **Mods** folder of **uModFramework**.
